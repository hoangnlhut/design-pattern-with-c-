...
namespace Adapter_Wrapper_Object
{
    public class ObjectAdapterImplementation
    {
        ...
        public class Adapter : ICityAdapter
        {
            public ExternalSystem extenalSystem { get; private set; } = new ExternalSystem();
            public City GetCity()
            {
                var getCity = extenalSystem.GetCity();
